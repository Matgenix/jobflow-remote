...
def test_job_info(job_controller, two_flows_four_jobs, run_check_cli) -> None:
...
def test_job_info_by_pid(job_controller, two_flows_four_jobs, run_check_cli):
...
def test_set_state(job_controller, two_flows_four_jobs, run_check_cli) -> None:
    from jobflow_remote.jobs.state import JobState
...
def test_rerun(job_controller, two_flows_four_jobs, run_check_cli) -> None:
...
def test_retry(job_controller, two_flows_four_jobs, run_check_cli) -> None:
    from jobflow_remote.jobs.state import JobState
...
def test_pause_resume(job_controller, two_flows_four_jobs, run_check_cli) -> None:
    from jobflow_remote.jobs.state import JobState
...
def test_stop_resume(job_controller, two_flows_four_jobs, run_check_cli) -> None:
    from jobflow_remote.jobs.state import JobState
...
def test_queue_out(job_controller, one_job, run_check_cli) -> None:
    from jobflow_remote.jobs.runner import Runner
...
def test_set_worker(job_controller, one_job, run_check_cli) -> None:
    run_check_cli(
...
def test_set_exec_config(job_controller, one_job, run_check_cli) -> None:
    run_check_cli(
...
def test_set_resources(job_controller, one_job, run_check_cli) -> None:
    run_check_cli(
...
def test_set_priority(job_controller, one_job, run_check_cli) -> None:
...
def test_job_dump(job_controller, one_job, tmp_dir, run_check_cli) -> None:
    import os
...
def test_output(job_controller, one_job, run_check_cli) -> None:
    from jobflow_remote.jobs.runner import Runner
...
def test_files_list(job_controller, one_job, run_check_cli) -> None:
    from jobflow_remote.jobs.runner import Runner
...
def test_files_get(job_controller, one_job, tmp_dir, run_check_cli) -> None:
    import os
...
def test_queries(job_controller, two_flows_four_jobs, run_check_cli) -> None:
    import datetime
...
def test_todir(job_controller, one_job, run_check_cli):
    from jobflow_remote.jobs.runner import Runner
